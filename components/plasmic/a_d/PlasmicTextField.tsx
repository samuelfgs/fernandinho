...
import Label from "../../Label"; // plasmic-import: NSeAYxAAEUAj/component
import TextInput from "../../TextInput"; // plasmic-import: 0sgHfVuhR_ez/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: YBjRBxFaX2dr/component
import Description from "../../Description"; // plasmic-import: BDZD7w_YE_aC/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: dcswTQKiNiea/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__xm1Sy, {
          [sty.freeBoxiconEnd__xm1SYaDKi6]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__xm1SYjFeN]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__xm1SYmqa2X]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___4LNzg, {
            [sty.freeBoxiconStart___4LNzGjFeN]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___4LNzGmqa2X]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__tZo7W)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__xgeqg, {
            [sty.freeBoxiconEnd__xgeqGaDKi6]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__xgeqGjFeN]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hdV7M)}
                role={"img"}
              />
            ),
