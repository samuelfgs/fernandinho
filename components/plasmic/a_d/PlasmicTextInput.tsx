...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: aUTxAm6Oat_O/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Icon7Icon
              className={classNames(projectcss.all, sty.svg__dJmLu)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Icon3Icon
              className={classNames(projectcss.all, sty.svg__zrdpq)}
              role={"img"}
            />
          ),
